...
function Badge({ status }: { status: string }) {
  ...
  return (
      <span
          className="inline-flex py-[2px] px-[8px] rounded-[5px] text-[11px] font-medium font-mono whitespace-nowrap"
...
export default function KeywordsPage() {
  ...
  const tdClass = "py-[11px] px-[14px] border-b border-[#2a2a2a] text-[13px] text-[#8e8ea0] align-middle"

  const pgb = (active: boolean) => `w-[28px] h-[28px] rounded-[6px] border text-[12px] flex items-center justify-center cursor-pointer transition-colors ${
            ...
            <div className="max-w-[1280px] mx-auto">
              ...
              <div className="flex items-start justify-between mb-[24px]">
                <div>
                  ...
                  <h1 className="text-[22px] font-semibold text-[#ececec] tracking-[-0.025em] m-0 flex items-center">
                    Keywords
                    {activeClient && (
                        <span className="text-[13px] font-normal text-[#10a37f] ml-[10px] font-mono">
                      {activeClient.domain}
                    </span>
                    )}
                  </h1>
                  <p className="text-[13px] text-[#8e8ea0] mt-[4px] mb-0">
              ...
              <div className="bg-[#2f2f2f] border border-[#3f3f3f] rounded-[12px] p-[20px]">
                {/* Filters */}
                <div className="flex gap-[8px] mb-[16px] flex-wrap items-center">
                  ...
                  <div className="relative">
                    <select
                        ...
                        className={`${selClass} min-w-[180px]`}
                    >
                  ...
                  <div className="relative">
                    <select
                        ...
                        className={`${selClass} min-w-[140px]`}
                    >
                  ...
                  {(clientId || status !== 'All') && (
                      <button
                          ...
                          className="px-[12px] h-[34px] rounded-[7px] border border-[#5a2020] bg-[#2a1515] text-[#f87171] text-[12px] cursor-pointer font-inherit hover:bg-[#3f1d1d] transition-colors"
                      >
                        ✕ Clear
                      </button>
                  )}
